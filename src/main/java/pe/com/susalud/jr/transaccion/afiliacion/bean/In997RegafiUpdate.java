...
/*  40 */     if (this.flag) {
/*  41 */       if (noTransaccion != null) this.noTransaccion = noTransaccion.trim(); else this.noTransaccion = "";
/*     */     }
/*  43 */     else if (noTransaccion != null) this.noTransaccion = noTransaccion; else this.noTransaccion = "";
/*     */   }
/*     */   
...
/*  52 */     if (this.flag) {
/*  53 */       if (idRemitente != null) this.idRemitente = idRemitente.trim(); else this.idRemitente = "";
/*     */     }
/*  55 */     else if (idRemitente != null) this.idRemitente = idRemitente; else this.idRemitente = "";
/*     */   }
/*     */   
...
/*  64 */     if (this.flag) {
/*  65 */       if (idReceptor != null) this.idReceptor = idReceptor.trim(); else this.idReceptor = "";
/*     */     }
/*  67 */     else if (idReceptor != null) this.idReceptor = idReceptor; else this.idReceptor = "";
/*     */   }
/*     */   
...
/*  76 */     if (this.flag) {
/*  77 */       if (feTransaccion != null) this.feTransaccion = feTransaccion.trim(); else this.feTransaccion = "";
/*     */     }
/*  79 */     else if (feTransaccion != null) this.feTransaccion = feTransaccion; else this.feTransaccion = "";
/*     */   }
/*     */   
...
/*  88 */     if (this.flag) {
/*  89 */       if (hoTransaccion != null) this.hoTransaccion = hoTransaccion.trim(); else this.hoTransaccion = "";
/*     */     }
/*  91 */     else if (hoTransaccion != null) this.hoTransaccion = hoTransaccion; else this.hoTransaccion = "";
/*     */   }
/*     */   
...
/* 100 */     if (this.flag) {
/* 101 */       if (idCorrelativo != null) this.idCorrelativo = idCorrelativo.trim(); else this.idCorrelativo = "";
/*     */     }
/* 103 */     else if (idCorrelativo != null) this.idCorrelativo = idCorrelativo; else this.idCorrelativo = "";
/*     */   }
/*     */   
...
/* 112 */     if (this.flag) {
/* 113 */       if (idTransaccion != null) this.idTransaccion = idTransaccion.trim(); else this.idTransaccion = "";
/*     */     }
/* 115 */     else if (idTransaccion != null) this.idTransaccion = idTransaccion; else { this.idTransaccion = "";
/*     */     }
/*     */   }
/*     */   
...
/* 125 */     if (this.flag) {
/* 126 */       if (excProceso != null) this.excProceso = excProceso.trim(); else this.excProceso = "";
/*     */     }
/* 128 */     else if (excProceso != null) this.excProceso = excProceso; else this.excProceso = "";
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/*     */   public void setIn271RegafiUpdateExcepcion(ArrayList<In997RegafiUpdateExcepcion> in997RegafiUpdateExcepcion) {
...
/* Location:              D:\WorkSpace\Desarrollo Afiliacion On Linea\Fuentes\FebanAfiliacionesFH\lib\jr-afiliacion-susalud_v1.5.jar!\pe\gob\susalud\jr\transaccion\susalud\bean\In997RegafiUpdate.class
