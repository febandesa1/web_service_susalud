...
public class In271RegafiUpdate {
	...
	/*     */ public void setTiFinalidad(String tiFinalidad) {
		/* 102 */ if (tiFinalidad != null)
			this.tiFinalidad = tiFinalidad.trim();
		else
			this.tiFinalidad = "";
		/*     */ }
	...
	/*     */ public void setCaRemitente(String caRemitente) {
		/* 110 */ if (caRemitente != null)
			this.caRemitente = caRemitente.trim();
		else
			this.caRemitente = "";
		/*     */ }
	...
	/*     */ public void setTiOperacion(String tiOperacion) {
		/* 118 */ if (tiOperacion != null)
			this.tiOperacion = tiOperacion.trim();
		else
			this.tiOperacion = "";
		/*     */ }
