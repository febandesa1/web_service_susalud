...
public class AfiliacionUtil {
	...
	//String fileName = "properties/configurationMQ.properties";
	...
	static public Properties loadFileMQConfig() throws Exception{
		...
		try {
			//String appBuildDate = java.util.ResourceBundle.getBundle("configurationMQ");
			...
			*/
			...
			//String fileName = "properties/configurationMQ.properties";
		    //ClassLoader classLoader = AfiliacionUtil.getClass().getClassLoader();
	...
	static public Trama997Bean procesarTrama997(String trama) throws Exception {
		...
		try {
			...
			logger.info("==========START CONNECTION MQ1=========");
	...
	static protected void leerArchivoCSV(String archivo, Map<String, String> mapa) throws Exception {
		...
		try {
			FileInputStream Fileinput = (FileInputStream) AfiliacionUtil.class.getClassLoader().getResourceAsStream(archivo);
